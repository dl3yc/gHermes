...
/* --------------------------------------------------------------------------*/
/** 
* @brief Callback when dbtest button is pressed
* 
* @param widget
* @param data
*/
/* ----------------------------------------------------------------------------*/
void dbTestCallback(GtkWidget* widget,gpointer data) {
    dbTest = 1;
}
...
static char* shortOptions="s:p:tmi:";
