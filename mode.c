...
void selectMode(GtkWidget* widget) {
    ...
    if(widget==buttonLSB) {
        mode=modeLSB;  if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonUSB) {
        mode=modeUSB; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonDSB) {
        mode=modeDSB; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonCWL) {
        mode=modeCWL; if (!aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonCWU) {
        mode=modeCWU; if (!aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonAM) {
        mode=modeAM; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonSAM) {
        mode=modeSAM; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonFMN) {
        mode=modeFMN; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonDIGL) {
        mode=modeDIGL; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonSPEC) {
        mode=modeSPEC; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonDIGU) {
        mode=modeDIGU; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    } else if(widget==buttonDRM) {
        mode=modeDRM; if (aRit) {gtk_button_clicked(GTK_BUTTON(buttonCW));};
    }
