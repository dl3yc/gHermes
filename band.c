...
static gchar const * const string160[] = { "160_a","160_b","160_c","160_d","160_e", NULL };
static gchar const * const string80[] = { "80_a","80_b","80_c","80_d","80_e", NULL };
static gchar const * const string40[] = { "40_a","40_b","40_c","40_d","40_e", NULL };
static gchar const * const string60[] = { "60_a","60_b","60_c","60_d","60_e", NULL };
static gchar const * const string30[] = { "30_a","30_b","30_c","30_d","30_e", NULL };
static gchar const * const string20[] = { "20_a","20_b","20_c","20_d","20_e", NULL };
static gchar const * const string17[] = { "17_a","17_b","17_c","17_d","17_e", NULL };
static gchar const * const string15[] = { "15_a","15_b","15_c","15_d","15_e", NULL };
static gchar const * const string12[] = { "12_a","12_b","12_c","12_d","12_e", NULL };
static gchar const * const string10[] = { "10_a","10_b","10_c","10_d","10_e", NULL };
static gchar const * const string6[] = { "6_a","6_b","6_c","6_d","6_e", NULL };
/* --------------------------------------------------------------------------*/
/** 
* @brief bandstack
*/
...
void selectBand(GtkWidget* widget) {
    ...
    if(currentBandButton) {
        ...
        if(displayHF) {switch(band){
	    case 0:gtk_label_set_text(label,"160");break;
	    case 1:gtk_label_set_text(label,"80");break;
	    case 2:gtk_label_set_text(label,"60");break;
	    case 3:gtk_label_set_text(label,"40");break;
	    case 4:gtk_label_set_text(label,"30");break;
	    case 5:gtk_label_set_text(label,"20");break;
	    case 6:gtk_label_set_text(label,"17");break;
	    case 7:gtk_label_set_text(label,"15");break;
	    case 8:gtk_label_set_text(label,"12");break;
	    case 9:gtk_label_set_text(label,"10");break;
	    case 10:gtk_label_set_text(label,"6");break;
	  };};
        gtk_widget_modify_fg(label, GTK_STATE_NORMAL, &black);
        gtk_widget_modify_fg(label, GTK_STATE_PRELIGHT, &white);
    }
...
//fprintf(stderr,"band:  %d\n",band);
    ...
    switch(band){
      case 0:gtk_label_set_text(label,string160[current]);break;
      case 1:gtk_label_set_text(label,string80[current]);break;
      case 2:gtk_label_set_text(label,string60[current]);break;
      case 3:gtk_label_set_text(label,string40[current]);break;
      case 4:gtk_label_set_text(label,string30[current]);break;
      case 5:gtk_label_set_text(label,string20[current]);break;
      case 6:gtk_label_set_text(label,string17[current]);break;
      case 7:gtk_label_set_text(label,string15[current]);break;
      case 8:gtk_label_set_text(label,string12[current]);break;
      case 9:gtk_label_set_text(label,string10[current]);break;
      case 10:gtk_label_set_text(label,string6[current]);break;
    };
